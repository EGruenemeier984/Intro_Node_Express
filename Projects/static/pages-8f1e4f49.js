...
$_mod.def("/marko$4.18.14/src/runtime/components/boot", function(require, exports, module, __filename, __dirname) { if (window.$initComponents) window.$initComponents();

});
$_mod.run("/marko$4.18.14/src/runtime/components/boot");